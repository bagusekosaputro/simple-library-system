...
class Command(BaseCommand):
    help = "Create user groups and add permissions for books"
    def handle(self, *args, **options):
        ...
        admin_permissions = [
            f"add_{Books.__name__.lower()}",
            f"change_{Books.__name__.lower()}",
            f"delete_{Books.__name__.lower()}",
            f"view_{Books.__name__.lower()}"
        ]
